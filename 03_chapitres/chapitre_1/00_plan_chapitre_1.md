# Plan du Chapitre 2  Cadre conceptuel et périmètre statistique

<!-- NOTE_INTERNE
Objet du fichier :
Vue d'ensemble du chapitre 2 : objectif, structure, logique d'ensemble.
...
- 2.7 (Limites méthodologiques)  fusionnée avec 2.6

Logique d'ensemble :
Le chapitre progresse du général (définitions, cadre OIT) vers l'opérationnel (périmètre,
classification des régimes, précautions de lecture). Les tableaux de la section 2.4 constituent
la carte d'identité institutionnelle du système de protection sociale RDC.

Fichiers du chapitre (ordre d'assemblage) :
1. 00_intro_chapitre_1.md
2. 1_1_definitions_approches.md
3. 1_2_approche_bit_oit.md
4. 1_3_champ_statistique.md
5. 1_4_classification_regimes.md
6. 1_5_concepts_statistiques.md   à rédiger
7. 1_6_precautions_lecture.md

Statut global : en cours de rédaction (sections 2.1 à 2.4 et 2.6 rédigées)
-->