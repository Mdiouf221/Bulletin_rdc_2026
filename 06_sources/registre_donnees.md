...
|---|---|---|---|---|---|---|
| `ESS CNSS 2019.xlsm` | CNSS | Tableau ESS OIT | Données statistiques standardisées CNSS | 2019 | Oui (.txt) | **Disponible** |
| `ESS CNSS 2020.xlsm` | CNSS | Tableau ESS OIT | **⚠️ ANOMALIE** : contenu CNSSAP (même contact, feuille "CNSAP Régime de base") — à vérifier | 2020 (?) | Oui (.txt) | **À vérifier** |
| `ESS CNSS 2021.xlsm` | CNSS | Tableau ESS OIT | Données statistiques standardisées CNSS | 2021 | Oui (.txt) | **Disponible** |
| `ESS CNSS 2022.xlsm` | CNSS | Tableau ESS OIT | Données statistiques standardisées CNSS | 2022 | Oui (.txt) | **Disponible** |

### ESS_CNSSAP/

| Fichier | Institution | Type | Description | Période | Converti | Statut |
|---|---|---|---|---|---|---|
| `ESS CNSSAP 2020.xlsm` | CNSSAP | Tableau ESS OIT | Données statistiques standardisées CNSSAP — 1 régime (pensions) — date interne affiche 2022 | 2020 | Oui (.txt) | **Disponible** |
| `ESS CNSSAP 2021.xlsm` | CNSSAP | Tableau ESS OIT | Données statistiques standardisées CNSSAP — 1 régime (pensions) — date interne affiche 2022 | 2021 | Oui (.txt) | **Disponible** |
| `ESS CNSSAP 2022.xlsm` | CNSSAP | Tableau ESS OIT | Données statistiques standardisées CNSSAP — 2 régimes (pensions + réforme du transfert) | 2022 | Oui (.txt) | **Disponible** |

### ESS_RDC_tous_regimes/

| Fichier | Institution | Type | Description | Période | Converti | Statut |
|---|---|---|---|---|---|---|
| `ESS RDC tous régimes.xlsx` | Compilation multi-régimes | Tableau ESS OIT consolidé | 15 régimes : CNSS (3), CNSSAP (3), FSS (5), MESP, MINAS, MEPST, STEP/IDA | 2023 | Oui (.txt) | **Disponible** |
